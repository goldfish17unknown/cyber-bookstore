        ...
        <div>
            <section className="p-5 h-auto grid grid-cols-7 border-b-2 border-gray-200">
                ...
                <div className="md:col-span-2 col-span-7">
                    ...
                    <img src="/placeholders/user-placeholder.png" alt="author-image"
                    className="rounded-full w-64 h-64" />
                </div>
                {/*  right side name and bio  and edit and delete button */}
                <div className="md:col-span-4 col-span-7 mt-6 ms-4">
                    <div>
                        <h1 className="md:text-4xl text-3xl font-bold my-4">Myo Myo Chan</h1>
                        <p>
                            {/* TODO:: to replace with real things */}
                            { showFullBio ? tempString : tempString.slice(0, 300) }
                            {tempString.length > 300 && (
